"""Removed the user_name from upload

Revision ID: ac9d582e5dbf
Revises: ea67374c473b
Create Date: 2024-12-03 13:36:47.467596
...
revision: str = 'ac9d582e5dbf'
down_revision: Union[str, None] = 'ea67374c473b'
...
def upgrade() -> None:
    ...
    op.drop_column('uploads', 'user_name')
